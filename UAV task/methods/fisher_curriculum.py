...
def pruning_curriculum_fisher(X_train_current_norm, U_train_curr_norm, X_train_current, X_train_next, U_train_curr,
    ...
    # fi_bins_pruned = [bin[int(len(bin)-len(bin)*learning_percentage):len(bin)] for bin in fi_bins] # Keep the top learning_percentage of each bin
    ...
    X_curr_NN = X_train_current_norm[bin_indices]
    U_curr_NN = U_train_curr_norm[bin_indices]
    X_curr = X_train_current[bin_indices]
    X_next = X_train_next[bin_indices]
    U_curr = U_train_curr[bin_indices]
    ...
    for i in range(n_bins):
        ...
        X_curr_NN_stage = X_train_current_norm[included_samples]
        U_curr_NN_stage = U_train_curr_norm[included_samples]
        X_curr_stage = X_train_current[included_samples]
        X_next_stage = X_train_next[included_samples]
        U_curr_stage = U_train_curr[included_samples]
